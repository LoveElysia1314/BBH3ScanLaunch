...
from mainWindow import LoginDialog
import requests
...
def write_conf(old=None):
    ...
    config_temp = json.loads('{"account":"","password":"","sleep_time":3,"ver":5,"clip_check":false,'
                             '"auto_close":false,"uid":0,"access_key":"","last_login_succ":false,'
                             '"bh_ver":"7.8.0","uname":"","auto_clip":false,"oa_token":"ebdda08dce6feb6bc552d393bae58c81",'
                             '"game_path":""}')  # 新增 game_path 字段
    if old is not None:
